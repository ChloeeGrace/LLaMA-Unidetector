...
class LLaMA_adapter(nn.Module):
    ...
    def forward_visual(self, imgs):
        ...
        visual_query, _ = self.visual_blocks(visual_query, 0)
    ...
    def generate(
        ...
        for cur_pos in range(start_pos, total_len):
            ...
            if temperature > 0:
                ...
                multiply_prob = multiply_prob * torch.max(probs)
                # max_prob += prob**2
                # num_list.append(max_prob)
        ...
        # # probability = max_prob/(total_len - start_pos)
        # length = len(num_list)
        # probability = max_prob / length
        # probability = (max_prob / length) ** 0.5
        decoded = []
        ...
        return decoded, multiply_prob#probability#max_prob
