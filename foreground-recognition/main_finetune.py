...
def get_args_parser():
    ...
    parser.add_argument('--llama_path', default='/data/WGQ/Weights/Pretrained/LLAMA/llama_model_weights/', type=str,
                        help='path to LLaMA pretrained checkpoint')

    parser.add_argument('--sam_path', default='../../sam_vit_h_4b8939.pth', type=str,
                        help='path to LLaMA pretrained checkpoint')
    ...
    parser.add_argument('--output_dir', default='/data/WGQ/Weights/Finetuned/SAM-LLAMA',
...
def main(args):
    ...
    dataset_train = FinetuneDataset(max_words=args.max_words, tokenizer_path=llama_tokenzier_path)
    print(dataset_train)
