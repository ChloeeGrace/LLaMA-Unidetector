...
--pretrain_model_path \
/data/XJL/open-vocabulary/object-localization/ckpt/checkpoint0033_4scale.pth \
--output_dir \
/data/XJL/open-vocabulary/object-localization/out/output36_RSdet_objectsmall \
-c \
