...
def make_coco_transforms(image_set, fix_size=False, strong_aug=False, args=None):
    ...
    if image_set in ['train', 'train_dinw', 'train_cocoobject', 'train_dota1.0object',
                     'train_dota2.0object', 'train_cocodota1.0object', 'train_dota1.0', 'train_dior',
                     'train_RSdet_object', 'train_finetune_dior', 'train_finetune_dota', 'train_finetune_nwpu',
                     'train_RSdet_object_small', 'train_RSdet_object_adddota', 'train_RSdet_object_debug']:
        if fix_size:
            return T.Compose([
    ...
    if image_set in ['val', 'eval_debug', 'train_reg', 'test', 'test_dinw', 'test_cocoobject', 'test_dota1.0object',
                     'test_dota2.0object', 'test_mix_dota2.0object', 'test_dota1.0', 'test_dior',
                     'test_RSdet_object_dior',
                     'test_RSdet_object_small_dior', 'test_RSdet_object_adddota_dior', 'test_RSdet_object_debug_dior',
                     'test_RSdet_object_small_dota', 'test_finetune_dior','test_finetune_dota', 'test_finetune_nwpu',
                     'test_RSdet_object_small_nwpu', 'val_object_nwpu_during_train']:
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "train_dinw": (root / "train/images", root / "annotations" / f'train_8001.json'),
        "test_dinw": (root / "test/images", root / "annotations" / f'test_8001.json'),
        "train_cocoobject": (root / "train2017", root / "annotations" / f'instance_train2017_cocoobject.json'),
        "test_cocoobject": (root / "val2017", root / "annotations" / f'instance_val2017_cocoobject.json'),
        "train_dota1.0object": (root / "train/images", root / "annotations" / f'train_8001_dota1.0.json'),
        "test_dota1.0object": (root / "val/images", root / "annotations" / f'val_8001_dota1.0.json'),
        "train_dota2.0object": (root / "train/images", root / "annotations" / f'train_8001_dota2.0.json'),
        "test_dota2.0object": (root / "val/images", root / "annotations" / f'val_8001_dota2.0.json'),
        "train_cocodota1.0object": (root / "train/images", root / "annotations" / f'mix_cocodota1.0.json'),
        "test_mix_dota2.0object": ("/data/XJL/dataset/od_dota/DOTA_V2.0/val/images",
                                   f'/data/XJL/dataset/od_dota/DOTA_V2.0/annotations/val_8001_dota2.0.json'),
        "train_dota1.0": (root / "train/images", root / "annotations" / f'train_8002_dota1.0.json'),
        "test_dota1.0": (root / "val/images", root / "annotations" / f'val_8002_dota1.0.json'),
        "train_dior": (root / "train/images", root / "annotations" / f'train_fb_dior_8001.json'),
        "test_dior": (root / "val/images", root / "annotations" / f'val_fb_dior_8001.json'),
        # "test_dior": (root / "val/debug/images", root / "val/debug" / f'debug_val_8001.json'),
        "train_RSdet_object": (root / "train/images", root / "annotations" / f'train_RSdet_object_8001.json'),
        "test_RSdet_object_dior": (root / "val/images", root / "annotations" / f'val_RSdet_object_dior_8001.json'),
        "train_RSdet_object_small": (root / "train/images", root / "annotations" / f'train_RSdet_object_small_8001.json'),
        "val_object_nwpu_during_train": (root / "val_nwpu/images", root / "annotations" / f'val_object_nwpu_during_train_8001.json'),
        "test_RSdet_object_small_dior": (root / "val/images", root / "annotations" / f'val_RSdet_object_small_dior_8001.json'),
        "test_RSdet_object_small_dota": (root / "val_dota/images", root / "annotations" / f'val_RSdet_object_small_dota_8001.json'),
        "test_RSdet_object_small_nwpu": (root / "val_nwpu/images", root / "annotations" / f'val_RSdet_object_small_nwpu_8001.json'),
        "train_finetune_dior": (root / "train/images", root / "annotations" / f'train_dior_finetune_8001.json'),
        "test_finetune_dior": (root / "val/images", root / "annotations" / f'val_RSdet_object_small_dior_8001.json'),
        "train_finetune_dota": (root / "train_dota/images", root / "annotations" / f'train_dota_finetune_8001.json'),
        "test_finetune_dota": (root / "val_dota/images", root / "annotations" / f'val_RSdet_object_small_dota_8001.json'),
        "train_finetune_nwpu": (root / "train_nwpu/images", root / "annotations" / f'train_nwpu_finetune_8001.json'),
        "test_finetune_nwpu": (root / "val_nwpu/images", root / "annotations" / f'val_RSdet_object_small_nwpu_8001.json'),
        "train_RSdet_object_adddota": (root / "train/images", root / "annotations" / f'train_RSdet_object_adddota_8001.json'),
        "test_RSdet_object_adddota_dior": (root / "val/images", root / "annotations" / f'val_RSdet_object_adddota_dior_8001.json'),
        "train_RSdet_object_debug": (root / "train/images", root / "annotations" / f'train_8001.json'),
        "test_RSdet_object_debug_dior": (root / "val/debug/images", root / "val/debug" / f'debug_val_8001.json'),
    }
